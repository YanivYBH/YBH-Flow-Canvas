    ...
    <div>
      <article >
          ...
          <div className="mt-6">
            ...
            <p>
            In the top-right corner, you will find the Preview button. This action will redirect you to a special preview page where you can view your flow without any editing options.
            </p>
            <div className='p-4 my-2'>
              <img className='rounded-md shadow-xl w-1/4 border' src='/doc/preview.png'/>
            </div>
