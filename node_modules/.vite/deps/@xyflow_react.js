...
function useQueue(runQueue) {
  const [shouldFlush, setShouldFlush] = (0, import_react2.useState)(false);
  const [queue] = (0, import_react2.useState)(() => createQueue(() => setShouldFlush(true)));
...
function useHandleConnections({ type, id: id2 = null, nodeId, onConnect, onDisconnect }) {
